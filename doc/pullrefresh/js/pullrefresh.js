(function(window) {
	...
	PullToRefresh.prototype.options = {
		...
		loadingWrap: document.querySelector('#container .load-wrap'),
		titleEl: document.querySelector(".loading-title"),
		textDown : '下拉刷新',
		textUp : '松开刷新',
		textRefresh : '刷新中',
		loadingDotEl: document.querySelector(".loading-dot"),
		loadingCircleEl: document.querySelector(".loading-cir"),
		callback: false,
		friction: 2.5,
		triggerDistance: 200
	};
